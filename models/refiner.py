...
'''
# LearnableGlobalLocalMultiheadAttention IMPROVE? / Trans-T
    ...
    def forward(self, features, patches):
        """
            inputs :
                ...
                patches: feature vectors of exemplar patches (query_number * B * C) with scale info
            returns :
        ...
        # append examplar feature to do self-similarity refining
        ...
        attention = self.softmax(energy)  # attention score
